          ...
          <div class="container">
            <div class="row">
              ...
              >
                ...
                <h5 class="text-white text-center" >Kerjasama ini didasarkan pada kesepakatan yang dituangkan dalam perjanjian kerjasama. Tautan ini akan membahas kerjasama-kerjasama Indonesia dengan negara pihak lainnya dalam hal menurunkan konsentrasi gas rumah kaca dan menanggulangi dampak buruk perubahan iklim.</h5>
              </div>
              <!-- Col end -->
            </div>
            <!-- Row end -->
